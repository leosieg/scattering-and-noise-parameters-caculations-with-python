...
#
# single frequency
#freq = np.linspace(5.0, 5.0, 1)*1e9
#dsp = 1
#
# frequency band
freq = np.linspace(4.9, 5.1, 201)*1e9
dsp = 0
#
#
#start = ti.time()
[s11, s12, s21, s22, cs11, cs12, cs22] = cir.amp_circuit_N(freq, dsp)
#ende = ti.time()
#delta_t = ende - start
#print(delta_t)
#
...
#
# values at frequency 5e9 Hz
fi = np.where(freq == 5e9)[0][0]
#
...
#
# save plot
plt.savefig('./plots/s21dB.svg', format='svg')
#
plt.figure(2)#########################################
# 
...
#
# save plot
plt.savefig('./plots/s11dB.svg', format='svg')
#
plt.figure(3)#########################################
# 
...
#
# save plot
plt.savefig('./plots/s22dB.svg', format='svg')
#
plt.figure(4)######################################### 
#
...
#
# save plot
plt.savefig('./plots/mu.svg', format='svg')
#
plt.figure(5)#########################################
#
sms.ssks(sp,'z')
#
# save plot
plt.savefig('./plots/ssks.svg', format='svg')
#
plt.figure(6)#########################################
#
sms.sskl(sp,'y')
#
# save plot
plt.savefig('./plots/sskl.svg', format='svg')
#
plt.figure(7)#########################################
#
...
# 
# save plot
plt.savefig('./plots/fmin.svg', format='svg')
#  
plt.figure(8)#########################################
#
...
#
# save plot
plt.savefig('./plots/ncir.svg', format='svg')
#
fig = plt.figure(9)#########################################
#
# with save plot ./plots/ncirp.svg
ax = noi.ncirp(noip, 'z')
#
ax.figure.savefig('./plots/ncirp.svg', format ='svg')
#
# without save plot 
#noi.ncirp(noip, 'y', 0)
#