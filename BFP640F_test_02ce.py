...
#
print(' ')
print('===== 3 port splitter input transistor =====')
print(' ')
# 3 port splitter input transistor
[rsp,rcs] = cn.Nnpc_xy(sp3s,cs3s,rsp,rcs,2,1,1)
#
print(' ')
print('===== S-parameters =====')
print(' ')
...
#
print(' ')
print('===== 3 port splitter output transistor =====')
print(' ')
# 3 portsplitter output transistor
[rsp,rcs] = cn.Nnpc_xy(rsp,rcs,sp3s,cs3s,3,1,1)
#
print(' ')
print('===== S-parameters =====')
print(' ')
...
print(' ')
#
# series impedance 300 Ohm
[spz,csz] = ll.z_series(300/50)
#
print(' ')
print('===== series impedance input splitter =====')
print(' ')
#
# series impedance connect to input splitter
[rsp,rcs] = cn.Nnpc_xy(rsp,rcs,spz,csz,2,1,1)
#
print(' ')
print('===== S-parameters =====')
print(' ')
...
#
print(' ')
print('===== series impedance output splitter =====')
print(' ')
#
# series impedance connect output splitter
[rsp,rcs] = cn.Nnpc_x(rsp,rcs,3,4,1)
#
print(' ')
print('===== S-parameters =====')
print(' ')
